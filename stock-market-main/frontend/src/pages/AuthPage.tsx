      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <button 
            ...
            className="font-medium text-blue-600 dark:text-[#2962FF] hover:text-blue-600 dark:text-[#2962FF]/80"
          >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {!isLogin && (
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input type="text" required className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-blue-600 dark:focus:ring-[#2962FF] focus:border-blue-600 dark:focus:border-[#2962FF] block w-full pl-10 sm:text-sm border-gray-200 dark:border-gray-800 rounded-md py-2 border outline-none" placeholder="John Doe" />
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input type="email" required className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-blue-600 dark:focus:ring-[#2962FF] focus:border-blue-600 dark:focus:border-[#2962FF] block w-full pl-10 sm:text-sm border-gray-200 dark:border-gray-800 rounded-md py-2 border outline-none" placeholder="you@example.com" />
              </div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div 
                    ...
                    className={`border rounded-lg p-3 cursor-pointer text-center transition-colors ${role === 'beginner' ? 'border-blue-600 dark:border-[#2962FF] bg-[#2962FF]/10 text-blue-600 dark:text-[#2962FF]' : 'border-gray-200 dark:border-gray-800 hover:border-blue-600 dark:border-[#2962FF]/30'}`}
                  >
                  ...
                  <div 
                    ...
                    className={`border rounded-lg p-3 cursor-pointer text-center transition-colors ${role === 'existing' ? 'border-blue-600 dark:border-[#2962FF] bg-[#2962FF]/10 text-blue-600 dark:text-[#2962FF]' : 'border-gray-200 dark:border-gray-800 hover:border-blue-600 dark:border-[#2962FF]/30'}`}
                  >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 text-blue-600 dark:text-[#2962FF] focus:ring-blue-600 dark:focus:ring-[#2962FF] border-gray-200 dark:border-gray-800 rounded bg-white dark:bg-gray-900" />
            ...
            <div>
              <button type="submit" className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-gray-900 dark:text-white bg-[#2962FF] hover:bg-[#2962FF]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 dark:focus:ring-[#2962FF] transition-colors">
